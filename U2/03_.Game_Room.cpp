...
-----Problem-----
Write a program for a company that has game rooms for all ages and wants to automatically calculate the price you should charge your customers for entering. The
